...
const canWeDeliver = (zipCode) => {
    ...
    {console.log('We got you!, You are in our Delivery Zone!')}
    else {
        console.log(`We're sorry! We can't deliver to your address!`)
    }
}
canWeDeliver(85203)
...
const canWeDeliverTwo = (zipCode) => {
    for (let i = 0; i < deliveryAreaZipCodes.length; i++) {
        if (deliveryAreaZipCodes[i] === zipCode) {
            console.log('We got you!, You are in our Delivery Zone!')}
            else {console.log(`We're sorry! We can't deliver to your address!`)}
    }
}
canWeDeliver(8520)
